...
@section('title', 'Iniciar Sesión - InventarioSmart')
...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 to-blue-800 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-2xl">
        ...
        <div class="text-center">
            ...
            <h2 class="text-3xl font-bold text-gray-900">InventarioSmart</h2>
            <p class="mt-2 text-sm text-gray-600">Iniciá sesión en tu cuenta</p>
        </div>
        ...
        <div class="mt-6">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-white text-gray-500">¿No tenés cuenta?</span>
                </div>
            </div>
